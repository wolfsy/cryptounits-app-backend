    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UserRole', models.CharField(default='USER', max_length=100)),
                ...
                ('UserFacebookURL', models.CharField(blank=True, max_length=255, null=True)),
                ('UserInstagramURL', models.CharField(blank=True, max_length=255, null=True)),
                ('UserTwitterURL', models.CharField(blank=True, max_length=255, null=True)),
